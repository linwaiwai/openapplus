        ...
        */
        ...
        var nt = {
                ...
                $getNormalizedEvent: function(t, e) {
                    ...
                    lower || (lower = n.charAt(0).toLowerCase() + n.slice(1));
                    var c = a["bind" + r] || a["bind" + lower] || a["on" + r] || a["catch" + r]|| a["on" + lower]|| a["catch" + lower];
                    if ((c || s) && (!s || !s.$target || c)) {
                        ...
                        h = l()({
                            ...
                            mixins: [st(c), function(t) {
                                ...
                                return {
                                    ...
                                    callRemoteGetUser: function(t, e, type) {
                            ...
                            $getEventHandler: function(t) {
                                ...
                                if (!this.eventHandlers[t]) {
                                    var n = this.eventHandlers[t] = function() {
                                        ...
                                        if (arguments.length === 1 && 'getUserInfo' === arguments[0]){
                                            e.callRemoteGetUser.apply(e, ["publicInstance", t, arguments[0]].concat(i))    
                                        } else {
        ...
        function o(t, e, n, i) {
            var o = e.charAt(0).toUpperCase() + e.slice(1),
                lower = e.charAt(0).toLowerCase() + e.slice(1),
                r = t.props["catch" + o],
            ...
            if (r && n.stopPropagation) return n.stopPropagation(), void r(a);
               if ("getUserInfo" === t.props["openType"]){
                var s = t.props["bindgetuserinfo"];
                a = 'getUserInfo';
               } else {
                var s = t.props["bind" + o] || t.props["bind" + lower] || t.props["on" + lower] || t.props["on" + o];
               }
            s && s(a)
        }
        ...
        function i(t, e, n) {
            var i = self,
                o = i.OpenApplusJSBridge;

            function r(i) {
                i && i.error && console.error("callBridge error:", t, e, i), n && n(i)
            }
            o ? o.call(t, e, r) : document.addEventListener("OpenApplusJSBridgeReady", function() {
                i.OpenApplusJSBridge.call(t, e, r)
            })
        }
        n.d(e, "a", function() {
            return i
        ...
        t.exports = {
            ...
            get Modal() {
                return  window.viewComponents.Modal;
            },
            get Picker() {
                var t = n(63);
                return t.default || t
        ...
        e.default = Object(s.h)({
            ...
            onChange: function(t) {
                var e = this.props.onInput || this.props.bindinput,
                    n = t.target.value,
                    i = void 0;
            ...
            onBlur: function(t) {
                var e = this.props.onBlur || this.props.bindblur,
                    n = t.target.value;
            ...
            onFocus: function(t) {
                var e = this.props.onFocus || this.props.bindfocus,
                    n = t.target.value;
        ...
        var i = n(1),
            ...
            u = Object(s.h)({
                ...
                componentDidMount: function() {
                    this.renderMap(),
//                   d && (this.detachPageUpdate = s.b.addEventListener("pageUpdate", this.renderMap)),
                   document.addEventListener("nbcomponent.map.bindmarkertap", this.onMarkerTap), document.addEventListener("nbcomponent.map.bindcontroltap", this.onControlTap), document.addEventListener("nbcomponent.map.bindregionchange", this.onRegionChange), document.addEventListener("nbcomponent.map.bindtap", this.onTap), document.addEventListener("nbcomponent.map.bindcallouttap", this.onCalloutTap)
                },
                componentDidUpdate: function() {
//                    this.renderMap()
                ...
                componentWillUnmount: function() {
                    this.props.$appx.bridge.call("NBComponent.remove", {
                        element: this.id
                    }), this.detachPageUpdate && this.detachPageUpdate(), document.removeEventListener("nbcomponent.map.bindmarkertap", this.onMarkerTap), document.removeEventListener("nbcomponent.map.bindcontroltap", this.onControlTap), document.removeEventListener("nbcomponent.map.bindregionchange", this.onRegionChange), document.removeEventListener("nbcomponent.map.bindtap", this.onTap), document.removeEventListener("nbcomponent.map.bindcallouttap", this.onCalloutTap)
                },
                getCenterLocation: function(e, t) {
                    this.props.$appx.bridge.call("NBComponent.sendMessage", {
                        element: this.id,
                        actionType: "getCenterLocation"
                    }, function(n) {
                        n && "longitude" in n ? e(n) : t(n)
                    })
                },
                ...
                onMarkerTap: function(e) {
                    var t = e.data,
                        n = t.element,
                        r = t.markerId;
                    !this.props.onMarkerTap || n !== this.id && n || this.props.onMarkerTap(this.props.$appx.getNormalizedEvent("markerTap", {
                        markerId: r
                    }))
                },
                onControlTap: function(e) {
                    var t = e.data,
                        n = t.element,
                        r = t.controlId;
                    !this.props.onControlTap || n !== this.id && n || this.props.onControlTap(this.props.$appx.getNormalizedEvent("controlTap", {
                        controlId: r
                    }))
                },
                onRegionChange: function(e) {
                    var t = e.data,
                        n = t.element,
                        r = t.regionChangedType,
                        o = t.latitude,
                        i = t.longitude,
                        a = t.scale;
                    n !== this.id && n || this.props.onRegionChange && this.props.onRegionChange(this.props.$appx.getNormalizedEvent("regionChange", {
                        type: r,
                        latitude: o,
                        longitude: i,
                        scale: a
                ...
                onTap: function(e) {
                    ...
                    !this.props.onTap || t !== this.id && t || this.props.onTap(this.props.$appx.getNormalizedEvent("tap"))
                },
                onCalloutTap: function(e) {
                    var t = e.data,
                        n = t.element,
                        r = t.markerId;
                    !this.props.onCalloutTap || n !== this.id && n || this.props.onCalloutTap(this.props.$appx.getNormalizedEvent("calloutTap", {
                        markerId: r
                    }))
                },
                renderMap: function() {
                   var e = this.props;
                   console.log(window.componentManager.getMap);
                   window.componentManager.getMap(document.getElementById(this.id),{
                       id: this.id,
                       type:"map",
                       props: {
                       ...
                       data: {
                           ...
                           controls: e.controls,
                           polygon: e.polygon,
                           "include-points": e.includePoints
                       }
                   });
                
//                   console.log(this.props.$appx.bridge);
//                    this.props.$appx.bridge.call("NBComponent.render", {
//                        id: this.id,
//                        type:"map",
//                        props: {
//                            longitude: e.longitude,
            ...
            S = Object(c.h)({
                ...
                onInput: function(t) {
                    ...
                    if (this.props.onInput) {
                        ...
                        this.props.bindinput || this.props.bindinput(t);
                    }
                    this.setState({
                        value: e
                    })
                ...
                onFocus: function() {
                    if (this.setState({
                            focused: !0
                    }), this.props.onFocus || this.props.bindfocus) {
                        ...
                        this.props.bindfocus || this.props.bindfocus(t);
                    }
                },
                onBlur: function(t) {
                    var e = this;
                    !this.props.password && y ?
//                    t.nativeEvent.simulated &&
                    this.setState({
                        focused: !1
                    }, function() {
                        e.blur()
        ...
        var i = n(0),
            ...
            h = Object(r.h)({
                ...
                _onSubmit: function(t, e, n) {
                    ...
                    this.props.onSubmit && this.props.onSubmit(o);
                    this.props.bindsubmit && this.props.bindsubmit(o);
                },
                submit: function(t) {
                    var e = this,
                        n = this.props,
                        i = n.onSubmit || this.props.bindsubmit,
                        o = n.reportSubmit,
                        r = n.receiverUserId;
                    if (i)
                        if (o) {
